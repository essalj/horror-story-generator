...
def story_inspiration():
    ...
    # prompt = role + "Suggest 5  plots for a classic horrorstory about AI"
    # prompt = role + "Suggest 5  plots for a horrorstory about a hacker hacking a neuro chip"
    prompt = role + "Suggest 5  plots for a horrorstory about jack the ripper."
...
# story idea
user_input = '''
**Echoes o Jack The Ripper**:
Detective Inspector Abigail Hart is haunted by an unsolved case from her past that echoes the infamous Ripper murders. When she's called to investigate a chilling murder in Whitechapel’s historic district—the site of the original killings—she can't shake the feeling that Jack's presence lingers. As Abi pieces together clues from both past and present, she 
uncovers more than just a copycat; she unravels a timeless evil that refuses to be buried, threatening her reality and that of London itself.
'''
