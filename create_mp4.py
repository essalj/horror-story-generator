...
def create_video_with_images_and_audio(xp_path, image_paths, audio_path, output_filename='final_video.mp4', fps=30):
...
create_video_with_images_and_audio(xp_path, image_path, audio_path, output_mp4, fps=30)
